            ...
            <div class="sidebar-wrapper">
                <nav class="mt-2">
                    ...
                    <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="navigation"
                        ...
                        <li class="nav-item">
                            <a href="../docs/how-to-contribute.blade.php" class="nav-link active">
                ...
                <div class="container-fluid">
                    ...
                    <ol>
                        ...
                        <li>
                            ...
                            <ul>
                                <li>
                                    Fork the repository (<a href="https://help.github.com/articles/fork-a-repo/">here
                                        is the guide</a>).
                                </li>
                            ...
                            <pre class="astro-code dark-plus" style="background-color: #1e1e1e; color: #d4d4d4; overflow-x: auto" tabindex="0"
                                data-language="bash"><code><span class="line"><span style="color:#DCDCAA">git</span><span style="color:#CE9178"> clone</span><span style="color:#CE9178"> https://github.com/YOUR_USERNAME/AdminLTE.git</span></span></code></pre>
                            <ul>
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <a href="https://gitpod.io/from-referrer/"><img
                                    src="https://gitpod.io/button/open-in-gitpod.svg" alt="Open in Gitpod" /></a>
                        </li>
