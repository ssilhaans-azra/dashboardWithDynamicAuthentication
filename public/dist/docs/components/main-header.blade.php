        ...
        <div class="app-wrapper">
            ...
            <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark">
                ...
                <div class="sidebar-brand">
                    <!--begin::Brand Link-->
                    <a href="{{ asset('dist/index.blade.php') }}" class="brand-link">
                        <!--begin::Brand Image-->
                    ...
                    <nav class="mt-2">
                        ...
                        <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="navigation"
                            ...
                            <li class="nav-item menu-open">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="../../docs/components/main-header.blade.php" class="nav-link active">
                                            <i class="nav-icon bi bi-circle"></i>
                                            <p>Main Header</p>
                                        </a>
                                    </li>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="callout callout-info mb-4">
                            ...
                            <p>
                                ...
                                on the component and choose “inspect element” to get to the blade.php quicker than
                                scanning the blade.php page.
                            </p>
                        </div>
                                    ...
                                    <li class="nav-item dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                                            ...
                                            <a href="#" class="dropdown-item">
                                                ...
                                                <div class="d-flex">
                                                    <div class="shrink-0">
                                                        <img src="../../assets/img/user8-128x128.jpg"
                                                            alt="User Avatar"
                                                            class="img-size-50 rounded-circle me-3" />
                                                    </div>
                                                    <div class="grow">
                                    ...
                                    <li class="nav-item dropdown user-menu">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                                            ...
                                            <li class="user-footer">
                                                ...
                                                <a href="#" class="btn btn-default btn-flat float-end"> Sign out
                                                </a>
                                            </li>
                                        </ul>
                                    </li>
                        ...
                        <pre class="astro-code dark-plus" style="background-color: #1e1e1e; color: #d4d4d4; overflow-x: auto" tabindex="0"
                            data-language="blade.php"><code><span class="line"><span style="color:#6A9955">&lt;!-- Navbar --&gt;</span></span>
...
<span class="line"><span style="color:#808080">              &lt;</span><span style="color:#569CD6">div</span><span style="color:#9CDCFE"> class</span><span style="color:#D4D4D4">=</span><span style="color:#CE9178">&quot;shrink-0&quot;</span><span style="color:#808080">&gt;</span></span>
...
<span class="line"><span style="color:#808080">              &lt;</span><span style="color:#569CD6">div</span><span style="color:#9CDCFE"> class</span><span style="color:#D4D4D4">=</span><span style="color:#CE9178">&quot;grow&quot;</span><span style="color:#808080">&gt;</span></span>
