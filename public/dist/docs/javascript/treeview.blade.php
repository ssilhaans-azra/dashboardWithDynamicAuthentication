                ...
                <nav class="mt-2">
                    ...
                    <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="navigation"
                        ...
                        <li class="nav-item menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="../../docs/javascript/treeview.blade.php" class="nav-link active">
                                        <i class="nav-icon bi bi-circle"></i>
                                        <p>Treeview</p>
                                    </a>
                                </li>
            ...
            <div class="app-content">
                ...
                <div class="container-fluid">
                    ...
                    <pre class="astro-code dark-plus" style="background-color: #1e1e1e; color: #d4d4d4; overflow-x: auto" tabindex="0"
                        data-language="html"><code><span class="line"><span style="color:#808080">&lt;</span><span style="color:#569CD6">ul</span><span style="color:#9CDCFE"> data-lte-toggle</span><span style="color:#D4D4D4">=</span><span style="color:#CE9178">&quot;treeview&quot;</span><span style="color:#808080">&gt;</span></span>
