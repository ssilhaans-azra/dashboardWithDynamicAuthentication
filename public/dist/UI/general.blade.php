                ...
                <nav class="mt-2">
                    ...
                    <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="navigation"
                        ...
                        <li class="nav-item menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="../UI/general.blade.php" class="nav-link active">
                                        <i class="nav-icon bi bi-circle"></i>
                                        <p>General</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="../forms/general.blade.php" class="nav-link active">
                                        <i class="nav-icon bi bi-circle"></i>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="card card-primary card-outline mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="progress mb-2" role="progressbar"
                                        aria-label="Info striped example" aria-valuenow="50" aria-valuemin="0"
                                        aria-valuemax="100">
                            ...
                            <div class="card card-primary card-outline mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="toast-container position-fixed bottom-0 end-0 p-3">
                                        <div id="toastDefault" class="toast" role="alert"
                            ...
                            <div class="card card-primary card-outline mb-4">
                                ...
                                <div class="card-body">
                                    <p class="muted">
                                        ...
                                        <a href="#" data-bs-toggle="tooltip"
                                            data-bs-title="Another tooltip">real text</a>. And all that just to give
                                        you an idea of how tooltips would look when used
