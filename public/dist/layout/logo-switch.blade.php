    ...
    <div class="app-wrapper">
        ...
        <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark">
            ...
            <div class="sidebar-brand">
                <!--begin::Brand Link-->
                <a href="../index.blade.php" class="brand-link logo-switch">
                    <!--begin::Brand Image Small-->
                    <img src="../assets/img/AdminLTELogo.png" alt="AdminLTE Logo Small"
                        class="brand-image-xl logo-xs opacity-75 shadow" />
                    <!--end::Brand Image Small-->
                    <!--begin::Brand Image Large-->
                    <img src="../assets/img/AdminLTEFullLogo.png" alt="AdminLTE Logo Large"
